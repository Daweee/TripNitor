...
class DriverItineraryDetailsPage extends StatefulWidget {
  final Package package;
  DriverItineraryDetailsPage({super.key, required this.package});

  @override
  State<DriverItineraryDetailsPage> createState() =>
      _DriverItineraryDetailsPageState();
}

class _DriverItineraryDetailsPageState
    extends State<DriverItineraryDetailsPage> {
  @override
